...
pub struct Domain {
    ...
    #[serde(default)] pub max_recipients_per_alias: Option<u32>,
    #[serde(default)] pub smtp_port: Option<String>,
    #[serde(default)] pub has_adult_content_protection: Option<bool>,
    #[serde(default)] pub has_phishing_protection: Option<bool>,
    #[serde(default)] pub has_executable_protection: Option<bool>,
    #[serde(default)] pub has_virus_protection: Option<bool>,
    #[serde(default)] pub has_recipient_verification: Option<bool>,
    #[serde(default)] pub retention_days: Option<u32>,
    #[serde(default)] pub has_mx_record: Option<bool>,
    #[serde(default)] pub has_txt_record: Option<bool>,
...
pub struct DomainRow {
    #[tabled(rename = "DOMAIN")] pub name: String,
    #[tabled(rename = "PLAN")] pub plan: String,
    #[tabled(rename = "MX")] pub mx: String,
    #[tabled(rename = "TXT")] pub txt: String,
    #[tabled(rename = "CREATED")] pub created_at: String,
}
...
impl From<&Domain> for DomainRow {
    fn from(d: &Domain) -> Self {
        DomainRow {
            ...
            mx: d.has_mx_record.map(|b| if b { "yes" } else { "no" }).unwrap_or("-").to_string(),
            txt: d.has_txt_record.map(|b| if b { "yes" } else { "no" }).unwrap_or("-").to_string(),
